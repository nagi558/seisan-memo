...
CREATE TABLE "Expense" (
    ...
    "selfSharePercent" INTEGER NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
-- AddCheckConstraint
-- selfSharePercentはPrisma Schema単体ではCHECK制約を表現できないため、
-- カスタムSQLとして0〜100の範囲制約をDBに追加する。
ALTER TABLE "Expense" ADD CONSTRAINT "Expense_selfSharePercent_range" CHECK ("selfSharePercent" >= 0 AND "selfSharePercent" <= 100);
